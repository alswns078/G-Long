...
This project is built upon the foundational framework provided by LD-Agent (Li et al., 2025). We adapted their modular architecture to integrate our Graph-Enhanced Memory bank and sLM-based Triplet Extraction mechanisms. We thank the authors for their open-source contribution.
